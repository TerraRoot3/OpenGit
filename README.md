...
- 内置终端：支持从浏览器菜单以新标签打开独立终端，项目终端支持内容恢复、无限水平/垂直分屏与拖拽调整大小
...
- Built-in terminal with standalone browser-menu entry, snapshot restore, unlimited horizontal/vertical splits, and draggable pane resizing
